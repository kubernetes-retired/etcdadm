...
func init() {
	...
	initCmd.PersistentFlags().Var(util.URLValue{URL: &etcdAdmConfig.AdditionalMetricsURL}, "listen-metrics-url", "Additional URL to expose /metrics endpoint without TLS")
}
