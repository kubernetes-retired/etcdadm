...
* Release notes for etcd-manager 3.0.20220203 [@justinsb](https://github.com/justinsb) [#293](https://github.com/kubernetes-sigs/etcdadm/pull/293)
* `make container-build` support GOPROXY env [@FOWind](https://github.com/FOWind) [#296](https://github.com/kubernetes-sigs/etcdadm/pull/296)
* Flags for etcd data dir and kubelet podspec dir [@g-gaston](https://github.com/g-gaston) [#290](https://github.com/kubernetes-sigs/etcdadm/pull/290)
* Document current release process for etcd-manager [@justinsb](https://github.com/justinsb) [#294](https://github.com/kubernetes-sigs/etcdadm/pull/294)
* etcd-manager - add support for etcd v3.5.3 [@rifelpet](https://github.com/rifelpet) [#303](https://github.com/kubernetes-sigs/etcdadm/pull/303)
* Set ETCD_EXPERIMENTAL_INITIAL_CORRUPT_CHECK for etcd 3.5.x [@justinsb](https://github.com/justinsb) [#304](https://github.com/kubernetes-sigs/etcdadm/pull/304)

# 3.0.20220717

* Update aws-sdk-go [@justinsb](https://github.com/justinsb) [#322](https://github.com/kubernetes-sigs/etcdadm/pull/322)
* Release etcd-manager/3.0.20220717 [@justinsb](https://github.com/justinsb) [#323](https://github.com/kubernetes-sigs/etcdadm/pull/323)

# 3.0.20220727

* Release notes for etcd-manager 3.0.20220717 [@justinsb](https://github.com/justinsb) [#324](https://github.com/kubernetes-sigs/etcdadm/pull/324)
* updated retention period from 7 years to 2 for daily backups [@SHreyank4Real](https://github.com/SHreyank4Real) [#327](https://github.com/kubernetes-sigs/etcdadm/pull/327)
* Fix reattachment of volumes for Hetzner [@hakman](https://github.com/hakman) [#328](https://github.com/kubernetes-sigs/etcdadm/pull/328)
* Release etcd-manager/v3.0.20220727 [@hakman](https://github.com/hakman) [#329](https://github.com/kubernetes-sigs/etcdadm/pull/329)

# 3.0.20220831

* Release notes for etcd-manager 3.0.20220727 [@hakman](https://github.com/hakman) [#330](https://github.com/kubernetes-sigs/etcdadm/pull/330)
* Add makefile targets for building etcd-manager [@hakman](https://github.com/hakman) [#332](https://github.com/kubernetes-sigs/etcdadm/pull/332)
* Update various dependencies [@olemarkus](https://github.com/olemarkus) [#331](https://github.com/kubernetes-sigs/etcdadm/pull/331)
* Add config drive as a source for OpenStack instance metadata [@ederst](https://github.com/ederst) [#318](https://github.com/kubernetes-sigs/etcdadm/pull/318)
* Use volume name tag to match the instance group for Hetzner [@hakman](https://github.com/hakman) [#334](https://github.com/kubernetes-sigs/etcdadm/pull/334)
* Wait for 1 minute for volume to be attached for Hetzner [@hakman](https://github.com/hakman) [#337](https://github.com/kubernetes-sigs/etcdadm/pull/337)
* Release etcd-manager/v3.0.20220831 [@hakman](https://github.com/hakman) [#338](https://github.com/kubernetes-sigs/etcdadm/pull/338)
